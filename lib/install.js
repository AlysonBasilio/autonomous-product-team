...
const MANIFEST = [
  { src: 'roles/team-manager.md', dest: '.claude/agents/team-manager.md', transform: rewriteTaskPaths },
  { src: 'roles/team-member.md',  dest: '.claude/agents/team-member.md' },
  { src: 'tasks/demo-review.md',         dest: '.claude/product-team/tasks/demo-review.md' },
  { src: 'tasks/implement-backend.md',   dest: '.claude/product-team/tasks/implement-backend.md' },
  { src: 'tasks/implement-frontend.md',  dest: '.claude/product-team/tasks/implement-frontend.md' },
